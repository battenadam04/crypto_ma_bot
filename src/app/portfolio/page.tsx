...
export const metadata: Metadata = {
  title: "Portfolio",
  description:
    "Explore my portfolio of web applications, e-commerce solutions, and digital experiences. See the projects that have helped businesses grow.",
};
      ...
      <section className="bg-gradient-to-b from-brand-50 to-surface-0 py-20">
        <div className="mx-auto max-w-7xl px-6 text-center">
          ...
          <p className="mt-4 text-lg text-surface-500 max-w-2xl mx-auto">
            A showcase of projects I&apos;ve built for businesses across various
